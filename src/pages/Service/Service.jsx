    ...
    return (
        <div className="flex flex-col items-start justify-start rounded-md drop-shadow-lg bg-white">
            ...
            <div className="p-4 flex flex-col gap-2">
                ...
                <Link><button className="font-semibold px-2 py-1 bg-blue-500 hover:bg-blue-700 active:bg-blue-900 duration-800 text-xs text-white rounded-sm">View Details</button></Link>
            </div>
        </div>
    );
};
